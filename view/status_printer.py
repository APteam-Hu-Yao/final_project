...
class StatusLabel(QWidget):
    ...
    def update_pause_status(self, status: bool, message: str):
        self.pause_label.setText(message)
        self.pause_light.setColor("green" if status else "red")

    def update_connection_status(self, status: bool, message: str):
        self.connection_label.setText(message)
        self.connection_light.setColor("green" if status else "red")